...
import { MOCK_ASSETS, type Asset } from "@/lib/mock-data";
import { cn } from "@/lib/utils";

const SPORTS_FILTER = ["All", "Basketball", "Soccer", "Track & Field", "Swimming", "Baseball", "Volleyball"];

function ScoreTicker({ assets }: { assets: Asset[] }) {
...
function FanAssetCard({ asset, liked, onLike }: { asset: Asset; liked: boolean; onLike: (id: string) => void }) {
  return (
      ...
      <main className="pt-20 pb-16 max-w-7xl mx-auto">
        ...
        <div className="px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {assetsWithUpdatedLikes.map((asset, i) => (
              <div
                key={asset.id}
          ...
          {assetsWithUpdatedLikes.length === 0 && (
