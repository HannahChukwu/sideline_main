...
-- ============================================================
-- GENERATION RATE LIMITS (/api/generate) — Postgres buckets + RPC
-- Replaces Redis for per-user hourly/daily caps (same env: GENERATE_RL_PER_HOUR / DAY).
-- ============================================================
...
-- 6. /api/generate rate limits use table generation_rate_buckets + consume_generation_rate_limit().
--    Existing projects: run supabase-migration-generation-rate-limit.sql if you added this after initial setup.
-- ============================================================
